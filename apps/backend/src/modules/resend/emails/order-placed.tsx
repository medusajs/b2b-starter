import { Text, Column, Container, Heading, Html, Img, Row, Section, Tailwind, Head, Preview, Body, Link } from "@react-email/components"
    ...
    return (
        <Tailwind>
            <Html className="font-sans bg-gray-100">
                <Head />
                <Preview>Thank you for your order from Maxxam</Preview>
                <Body className="bg-white my-10 mx-auto w-full max-w-2xl">
                    ...
                    <Container className="p-6">
                        ...
                        <Text className="text-center text-gray-600 mt-2">
                            We're processing your order and will notify you when it is ready for delivery.
                        </Text>
                    </Container>
                    ...
                    <Section className="bg-gray-50 p-6 mt-10">
                        <Text className="text-center text-gray-500 text-sm">
                            If you have any questions, reply to this email or contact our support team at support@maxxam.com.au
                        </Text>
                        <Text className="text-center text-gray-500 text-sm">
