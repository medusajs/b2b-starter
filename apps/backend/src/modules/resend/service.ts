...
class ResendNotificationProviderService extends AbstractNotificationProviderService {
    ...
    getTemplateSubject(template: Templates) {
        ...
        switch (template) {
            case Templates.ORDER_PLACED: return "Order Confirmation"
            case Templates.ORDER_DELIVERED: return "Order Delivered"
            case Templates.ORDER_SENT: return "Order Sent"
            case Templates.REQUEST_RECEIVED: return "Request Received"
            default:
                return "New Email"
        }
    }
    ...
    async send(notification: ProviderSendNotificationDTO): Promise<ProviderSendNotificationResultsDTO> {
        ...
        if (typeof template === "string") {
            ...
            emailOptions = { ...commonOptions, react: template(notification.data), }
        }
